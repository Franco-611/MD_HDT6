...
Podemos observar que el modelo de Random Forest es el que mejor desempeño tuvo con un accuracy de 0.899. El modelo de Naive Bayes tuvo un accuracy de 0.805 y el modelo de Arbol de Clasificacion tuvo un accuracy de 0.866. El que más tardó fue el Random Forest con un tiempo de `r pm5$sampling.time`s. El arbol de Clasificacion tuvo la mayor cantidad de falsos positivos con un total de 37, mientras que el Random Fores tuvo la mayor cantidad de falsos negativos con un total de 95. El modelo que menos se equivocó fue el Random Forest, cosa que se puede observar tanto en la matriz de confusión como en el accuracy.  
